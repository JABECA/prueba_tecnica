...
<div class="card">
  ...
  <form method="POST" action="{{ route('ciudades.store') }}" class="grid">
    @csrf

    <div>
      <label for="nombre">Nombre de la ciudad</label>
      <input type="text" id="nombre" name="nombre" value="{{ old('nombre') }}" class="form-control" style="width:100%" required>
